...
![image-20211112175305460](D:\Program Files (x86)\Typora\images\4.SpringCloud入门教程\image-20211112175305460.png)  

`原始模式`：控制台配置的规则直接推送到Sentinel客户端，也就是我们的应用，然后保存在内存中，服务重启则丢失。

![image-20211112174743861](D:\Program Files (x86)\Typora\images\4.SpringCloud入门教程\image-20211112174743861.png) 

`Pull模式`：控制台将配置的规则推送到Sentinel客户端，而客户端会将配置规则保存在本地文件或数据库中，以后会定时去本地文件或数据库中查询，更新本地规则。

![image-20211112174839087](D:\Program Files (x86)\Typora\images\4.SpringCloud入门教程\image-20211112174839087.png) 

`Push模式`：控制台将配置规则推送到远程配置中心，例如Nacos，然后Sentinel客户端监听Nacos，获取配置变更的推送消息，完成本地配置更新。

![image-20211112174925429](D:\Program Files (x86)\Typora\images\4.SpringCloud入门教程\image-20211112174925429.png) 
